...
struct CustomTopBar: View {
    ...
    private let categories: [LocalizedStringKey] = ["all", "sale", "rent", "favorites"]
                ...
                VStack(spacing: 5) {
                    ...
                    Button(action: {
                        ...
                        Text(categories[index])
                            .font(.caption)
                            .foregroundStyle(selectedItem == index ? .primaryText : .secondaryText)
                            .fontWeight(selectedItem == index ? .semibold : .regular)
                    })
